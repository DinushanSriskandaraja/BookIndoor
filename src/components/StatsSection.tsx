...
export default function StatsSection() {
  ...
  return (
    <section
      ref={ref}
      className="py-20 px-8 bg-green-800 text-center"
    >
      <h3 className="text-3xl font-bold mb-10 text-white">Our Community</h3>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-5xl mx-auto">
        {stats.map((stat, index) => (
          <motion.div
            ...
            className="p-6 bg-white rounded-2xl border border-green-700/40 shadow-lg"
          >
